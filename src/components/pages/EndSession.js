    ...
    render() {
        ...
        return (
            <div className="endsession-container">
                ...
                <NavLink to={{pathname :'./endsessionreco' , artistId : this.props.location.state }} className="link-for-recopage" ><button className="button-go-reco" >Artist similar</button> </NavLink>
                <EndSessionShare />
