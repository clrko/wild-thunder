    ...
    render() {
        ...
        return (
            <div className="globalForm">
                ...
                <NavLink to={{pathname: `/mode-page/${this.state.username}`, username:this.state.username}} className="goHome_button"><button><FontAwesomeIcon icon={faHome} className="goHome_icon" /></button></NavLink>
                {scoresTab}
            </div>
        )
    }
